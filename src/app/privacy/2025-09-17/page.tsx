...
export const metadata = {
  title: "Privacy Policy (September 17, 2025) | BarrelBook",
  description: "Archived BarrelBook Privacy Policy dated September 17, 2025",
  robots: {
    index: false,
    follow: true,
  },
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 rounded-lg border border-[#333333] bg-[#0F0F0F] p-4">
            ...
            <p className="mt-2 text-sm text-gray-400">
              <Link href="/privacy" className="text-[#D2691E] underline hover:text-[#E07A2B]">View the current Privacy Policy</Link>
            </p>
          </div>
